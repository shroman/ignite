...
import static org.apache.ignite.internal.processors.rest.protocols.tcp.redis.GridRedisCommand.HGET;

/**
 * Redis HGET command handler.
 */
public class GridRedisHGetCommandHandler extends GridRedisHashCommandHandler {
    /** Supported commands. */
     ...
     * @param ctx Context.
     */
    public GridRedisHGetCommandHandler(final IgniteLogger log, final GridRestProtocolHandler hnd,
