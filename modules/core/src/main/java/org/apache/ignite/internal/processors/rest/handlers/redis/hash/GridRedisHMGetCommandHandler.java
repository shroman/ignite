...
import static org.apache.ignite.internal.processors.rest.protocols.tcp.redis.GridRedisCommand.HMGET;

/**
 * Redis HMGET command handler.
 */
public class GridRedisHMGetCommandHandler extends GridRedisHashCommandHandler {
    /** Supported commands. */
     ...
     * @param ctx Context.
     */
    public GridRedisHMGetCommandHandler(final IgniteLogger log, final GridRestProtocolHandler hnd,
